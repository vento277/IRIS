# Lib of possible IRIS responses
...
def free():
    ...
    'an empty day sir', 'you have an empty schdule sir']
...
# Bye
b_before_night = ['Be back soon boss', 'Be back soon boss, you have a game to play', 
